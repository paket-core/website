    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="20"
        ...
        <tr>
            <td align="center"><a href="#" target="_blank" style="text-decoration:none;"><img
                            src="{{env('APP_URL')}}/images/email/reset_password.png" width="560" height="276"
        ...
        <tr>
            <td align="left"
                ...
                @lang('ico-template::emails.hello',['NAME' =>  ' '.$name])
            </td>
        </tr>
        <tr>
            <td align="left"
            ...
            <td align="center">
                <a href="{{$link}}">
                    <button style="background-color: #2190F5; color: #fff; outline: none; border: none; padding: 10px 20px;">
                        @lang('ico-template::emails.forgotten_button')
                    </button>
                </a>
            </td>
        </tr>
        ...
        <tr>
            <td align="left"
                style="font-family:'Open Sans', Arial, sans-serif; font-size:17px; line-height:32px; color:#000; padding: 0 20px;">
                @lang('ico-template::emails.forgotten_change_ignore',['NAME' =>  $name])
            </td>
        </tr>
        <tr>
            <td align="left"
