                ...
                <div class="section section-right animated fadeInRight">
                    <div class="col-md-9">
                        <div class="form-wrapper">
                            ...
                            {!!  \TokenChef\IcoTemplate\Services\WidgetService::get_forgotten_password_form() !!}

                            <button class="btn btn-blue-dark form-button forgotten-password-form-btn">
                                @lang('auth.forgotten_button')
                            </button>
