    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="20"
        ...
        <tr>
            <td align="left"
                ...
                @lang('ico-template::emails.hello',['NAME' => $receiver_name])
            </td>
        </tr>
        <tr>
            <td align="left"
                style="font-family:'Open Sans', Arial, sans-serif; font-size:17px; line-height:32px; color:#000; padding: 0 20px;">
                @lang('ico-template::emails.email_invitation_desc',['NAME' =>  '<strong>'.$name.'</strong>'])
            </td>
        </tr>
        <tr>
            <td align="center">
                <a href="{{$link}}">
                    <button style="background-color: #0a2053; color: #fff; outline: none; border: none; padding: 10px 20px;">
                        @lang('ico-template::emails.email_invitation_join_ico')
                    </button>
                </a>
            </td>
        </tr>
