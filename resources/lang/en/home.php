...
return [
    ...
    */
    ...
    'about_desc_2' => 'Bitcoin revolutionized the payment industry by decentralizing it.<br/>PAKET answers a similar need - transferring goods in a decentralized manner. We see this as an opportunity to resolve a real-world problem using the principals of blockchain technology in their purest form: a genuine way to exchange physical value between people, without any central authority managing the process and taking a significant commission.',
    'about_btn' => 'Token Sale Info',

    'project_1_title' => 'Truly Decentralized and Open',
    'project_1_desc' => 'Because an efficient system is one that lets every part do what it does best, and because everybody stands to win from a decentralized way of transporting goods. The PAKET platform is open to everybody, doesn\'t take any commission, and is fully transparent. The PAKET Project does not raise funds by selling equity or shares, and the only way to support the system is by using the network and becoming a part of it - buying, using, and earning BUL tokens.',
    'project_2_title' => 'Why we chose Stellar',
    'project_2_desc' => 'Because the Stellar network, which connects payments, systems and people, can move value quickly, reliably, securely, and at almost no cost. It is a perfect match for our need for a low friction transactional layer. We chose Stellar as our initial consensus layer for its level-headedness, its blazingly fast transaction rate, and its extremely low fees. From all the mature distributed ledger platforms currently active in the market, Stellar was the obvious decision for us. Read more about Stellar <a href="https://www.stellar.org/" target="_blank">here</a>.',
    ...
    'project_4_desc' => 'Uber and Airbnb are disrupting entire industries. They represent the spreading collaborative, on-demand, peer-to-peer economy that is changing the way of doing business. The PAKET platform brings the sharing economy into the delivery industry by exposing worldwide supply and demand. Real-time data communication and tracking, delivery insurance and advanced routing techniques are just a small part of what this platform has to offer.',
    'project_5_title' => 'Environmentally Friendly',
    'project_5_desc' => 'Optimizing delivery routes will significantly reduce the amount of energy spent &lt; and of fossil fuels burned. We can reduce the global carbon footprint just by moving last mile deliveries from fleets of trucks to local couriers on bicycles, or even to people carrying packages on the way, as part of their daily routine.',
    'project_6_title' => 'P2P deliveries',
    'project_6_desc' => 'Millions of people worldwide are members of online marketplaces for the exchange of goods. A key problem for these communities is transporting the goods, and the lack of trust between strangers is a huge obstacle for real P2P trade. Small online retailers face similar challenges as they lack the means to compete with industry giants in terms of logistics. With the PAKET platform, these problems become a thing of the past.',
    ...
    'ecosystem_graph_desc_3' => 'An open delivery network is a fertile ground for supporting services which can thrive within this new economy: insurance providers, courier co-ops, routing specialists, data scientists and analysers, and many more.',
    ...
    'ecosystem_graph_desc_6' => 'People who wish to have goods transported from one place to another and are willing to pay for it, either using blockchain technology and smart contracts or good old fashioned fiat money',
