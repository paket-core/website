...
return [
    ...
    'about_desc_2' => 'Биткойн совершил настоящую революцию, децентрализировав платежную индустрию. PAKET <br/> отвечает на похожий запрос - децентрализованная передача товаров на расстояние. <br/> Мы видим в этом возможность решить проблему в реальном мире используя принципы технологии блокчейна в своей самой рафинированной форме: подлиный способ обмена материальными ценностями между людьми, без участия центральной власти которая бы управляла процессом взымая изрядные комиссионные.',
    'about_btn' => 'Информация о Продаже Токенов',
    'project_1_title' => 'Подлинно Децентрализованная и Открытая',
    'project_1_desc' => 'Так как эффективные системы позволяют каждой своей части делать то, что она делает лучше всего, и так как все выигрывают от более эффективного способа передачи посылок. Платформа PAKET открыта для всех, не взымает никаких комиссионных, и абсолютно прозрачна. Проект PAKET не собирает средства продавая свой PAKET акций, и единственный способ поддержать систему это участие в сети - покупка, использование и зарабатывание токенов BUL.',
    ...
    'project_3_desc' => 'PAKET Протокол устанвливает доверие и позволяет нескольким сторонам сотрудничать над безопасной и своевременной доставкой товаров. Ради модульности и  прочности протокол  разделен на следующие уровни:',
    ...
    'project_3_li_4' => '<strong>L4 (Организация) – </strong>Создание организаций и сервисов которые обогащают экосистему PAKET. Уровень экономики.',
    'project_4_title' => 'Экономика Шеринга',
    'project_4_desc' => 'Uber и AirBnB подрывают устои целых индустрий. Пиринговая экономика сотрудничества в реальном времени распостраняется и меняет то как мы делаем бизнес. Платформа PAKET приносит экономику шеринга в индустрию доставки раскрывая спрос и предложение на эти услуги по всему миру. Коммуникация в режиме реального времени, отслеживание посылок, страховка и продвинутые техники нахождения оптимальных маршрутов - все это только малая часть того что предлагает эта платформа.',
    ...
    'project_6_desc' => 'Миллионы людей по всему миру участвуют в онлайн-рынках на которых они обмениваются с другими участниками. Ключевая проблема таких сообществ это транспортировка товаров и отсутствие товаров между незнакомыми людьми это огромное препятствие для подлинного пирингового обмена. Мелкие онлайн-торговцы также сталкиваются со схожими трудностями, так как они не могут конкурировать с логистикой гигантов индустрии. С платформой PAKET эти проблемы уходят в прошлое.',
    'project_7_title' => '"Некоммерциализированное" Большинство',
    'project_7_desc' => 'Граждане стран первого мира часто жалуются на неэффективность, ограничения и высокую стоимость современных доставок, но при этом они забывают о том, что в большинстве стран надежные доставки не существуют как класс. Экосистема PAKET все это меняет давая глобальное покрытие везде где есть спрос, решая реальную для огромного количества людей проблему,  и наконец-то предоставляет надежный сервис доставок нетронутому рынку гигантских размеров.',
    'ecosystem_title' => 'Экосистема Токена',
    'ecosystem_desc' => 'Платформа PAKET является открытой и бесплатной. Хотите что-то улучшить в ней, или может быть создать приложение для нового целевого рынка? Присоединяйтесь в наши гитхаб проекты и участвуйте в экосистеме добавляя свои изменения. Если ваше приложение предоставляет необходимую услугу, вы даже можете брать за него деньги.',
    ...
    'partners_desc' => '',
    'team_title' => 'Команда',
    'team_desc' => 'Многие люди по-разному поддерживают наш проект. Перечисленные члены команды это только те, для кого проект PAKET это основная работа.',
    'endorsements_title' => 'Заявления о поддержке',
    'endorsements_desc' => 'Мы благодарны многим людям за их помощь и поддержку, и особенно благодарны перечисленным ниже лидерам индустрии за их подпись на официальном письме поддержки проекта PAKET',
    'endorsements_link' => 'Прочитать полное письмо',
    'road_map_title' => 'Дорожная карта',
    'top_title' => 'PAKET',
    'top_desc' => 'Открытый протокол доставки посылок, на котором международные, местные и индивидуальные курьеры могут сотрудничать.',
    'play_video' => 'Проиграть Видео',
    'top_join_now' => 'Информация о Продаже Токенов',
    'top_action_wp' => 'White Paper',
    'top_action_telegram' => 'Присоединитесь к нашей группе в Телеграм',
    'pre_sale_title' => 'ПУБЛИЧНЫЙ ПРИ-СЕЙЛ',
    'pre_sale_learn_title' => 'УЗНАТЬ ЕЩЕ',
    'pre_sale_learn_desc' => 'Для короткого введения в то как работает PAKET',
    'pre_sale_learn_btn' => 'Читать наш  Light-Paper',
    'pre_sale_learn_desc_2' => 'Для детального описания открытого протокола PAKET',
    'pre_sale_learn_btn_2' => 'Читать наш  White-Paper',
    'pre_sale_updates_title' => 'ОСТАВАЙТЕСЬ НА СВЯЗИ',
    'pre_sale_updates_desc' => 'Зарегистрируйте ваш адрес электронной почты чтобы получать регулярные новости от проекта PAKET',
    ...
    'footer_copyright' => '2017-2018 Проект Paket  LTD',
