<ul class="payments referral-payments">
    ...
    <li class="payment-header">
        ...
        <div class="tokens colored">@lang('ico-template::home.payment_bonus',['BONUS' => env('PRIVATE_REFERRAL_BONUS_TOKENS',10)])</div>
    </li>
        ...
        @if (count($payments) >0)
            ...
            @foreach($payments as $payment)
                <li class="payment">
                    ...
                    <div class="tokens">{{\TokenChef\IcoTemplate\Services\AdditionalPaymentService::get_private_referral_bonus($payment)}}</div>
                </li>
            @endforeach
        @endif
    @endforeach
