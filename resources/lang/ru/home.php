...
//    'about_desc_1_li_3_title' => 'Decentralized network',
    ...
    'project_4_desc' => 'Uber и AirBnB подрывают устои целых индустрий. Пиринговая экономика сотрудничества в реальном времени распостраняется и меняет то как мы ведем бизнес. Платформа PAKET приносит экономику шеринга в индустрию доставки раскрывая спрос и предложение на эти услуги по всему миру. Коммуникация в режиме реального времени, отслеживание посылок, страховка и продвинутые техники нахождения оптимальных маршрутов - все это только малая часть того что предлагает эта платформа.',
