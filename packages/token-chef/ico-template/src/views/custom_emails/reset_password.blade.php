                        ...
                        <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                            <tbody><tr>
                                ...
                                <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                    ...
                                    <h1>@lang('ico-template::custom_emails.forgotten_title')</h1>

                                    <p>@lang('ico-template::custom_emails.forgotten_change_desc')<br>
                                        &nbsp;</p>
                                </td>
                            </tr>
                            </tbody></table>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="mcnButtonContentContainer" style="border-collapse: separate !important;border: 1px none #E221C2;border-radius: 10px;background-color: #11984E;">
                            ...
                            <tr>
                                <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Roboto, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; font-size: 18px; padding: 15px;">
                                    <a class="mcnButton " title="@lang('ico-template::custom_emails.forgotten_button')" href="{{$link}}" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">@lang('ico-template::custom_emails.forgotten_button')</a>
                                </td>
                            </tr>
                            </tbody>
                        </table>
                        ...
                        <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                            <tbody><tr>
                                ...
                                <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                    ...
                                    <p>@lang('ico-template::custom_emails.forgotten_change_ignore')<br>
                                        &nbsp;</p>
                                </td>
                            </tr>
                            </tbody></table>
