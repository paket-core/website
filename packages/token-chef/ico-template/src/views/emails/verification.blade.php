    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="20"
        ...
        <tr>
            <td align="center"><a href="#" target="_blank" style="text-decoration:none;"><img
                            src="{{env('APP_URL')}}/images/email/verification.png" width="560" height="276"
                            style="display:block;font-family: Arial, sans-serif; font-size:15px; line-height:18px; color:#181818;  font-weight:bold;"
      ...
      'COMPANY' => \TokenChef\IcoTemplate\Services\ICOSettingsService::get_company_name()
        ...
        <tr>
            <td align="left"
                ...
                @lang('ico-template::emails.click_verification_link')@if ('password') @lang('ico-template::emails.click_verification_link_password')@endif:
            </td>
        </tr>
        <tr>
            <td align="center">
                <a href="{{$link}}">
                    <button style="background-color: #2190F5; color: #fff; outline: none; border: none; padding: 10px 20px;">
