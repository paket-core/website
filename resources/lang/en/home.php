...
We’re creating a network that will allow everyone to take part in a global package delivery network that has no central authority.',
    ...
    'project_3_li_3' => '<strong>L3 (Application) – </strong>consolidates tools and applications that allow simple and intuitive usage of the network.',
    ...
    'project_5_desc' => 'Optimizing delivery routes will significantly reduce the amount of energy spent and fossil fuels burned. Just by moving last mile deliveries from fleets of trucks to local couriers on bicycles, or even to people carrying packages on the way, as part of their daily routine, we can significantly reduce global carbon footprint.',
    ...
    'project_7_desc' => 'Citizens of the first world often complain about the inefficiencies, limitations, and high cost of modern deliveries, but often forget that in most of the world reliable deliveries are not even an option. The PAKET ecosystem changes all that, providing global coverage wherever demand exists, solving a very real problem for a huge number of people, and finally providing a reliable trusted delivery service to a so far untapped market of staggering proportions.',
